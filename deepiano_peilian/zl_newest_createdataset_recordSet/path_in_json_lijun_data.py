...
if __name__ == '__main__':
    ...
    serialize_dir = '/deepiano_data/zhaoliang/lijun_data/serialize_bgm_record'
    json_dir = '/deepiano_data/zhaoliang/lijun_data/json_bgm_record'
    if not os.path.isdir(json_dir):
        os.makedirs(json_dir)
    base_dir = '/deepiano_data/dataset'
    dataset = ['bgm_record_20220411',
               'bgm_record_20220414',
               'bgm_record_20220415',
               'bgm_record_20220420',
               'bgm_record_20220428',
