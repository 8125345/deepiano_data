...
def to_serialize(npy_files, output_dir):
    ...
    for npy_file in npy_files:
        try:
            ...
            tmp_output_dir = output_dir + '/' + x[-5] + '/' + x[-4] + '/' + x[-3] + '/' + x[-2]
...
if __name__ == '__main__':
    input_dir = '/deepiano_data/zhaoliang/xuanran_original/npy_xuanran_ori'
    output_dir0 = '/deepiano_data/zhaoliang/xuanran_original/serialize_xuanran_ori'
