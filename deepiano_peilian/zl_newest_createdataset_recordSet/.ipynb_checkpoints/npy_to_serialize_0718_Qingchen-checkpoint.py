...
input_dir = '/deepiano_data/yuxiaofei/work/data_0718/npy_changpu_delay_Qingchen_SC55_metronome' # './data/npy'#
output_dir0 = '/deepiano_data/yuxiaofei/work/data_0718/serialize_changpu_delay_Qingchen_SC55_metronome' #'./data/serialize'# 
def main():
    all_wav_dir = []
