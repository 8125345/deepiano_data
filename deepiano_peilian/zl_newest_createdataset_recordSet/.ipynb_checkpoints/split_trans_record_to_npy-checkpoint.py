...
tf.app.flags.DEFINE_enum('dataset', 'bgm_record_20220411', ['bgm_record_20220411',
                                                            'bgm_record_20220414',
                                                            'bgm_record_20220415',
                                                            'bgm_record_20220420',
                                                            'bgm_record_20220428',
                                                            'bgm_record_20220429',
                                                            'ai-tagging_-20_-5_noised',
                                                            'ai-tagging',
                                                            'high-note_-20_-5_noised',
                                                            'newmusic',
                                                            'bgm_record_peilian',
                                                            'single-note_-20_-5_noised',
...
def wav_data_mid_to_chunk(wav_data, ns, dst_dir, min_length=5, max_length=20, pre_audio_transform=False, hparams=None):
    try:
    ...
    for midi_filename, audio_filename in dataset:
        ...
        if os.path.isfile(midi_file_path) and os.path.isfile(audio_file_path):
            try:
                ...
                wav_data_mid_to_chunk(wav_data, ns, tmp_output_dir, min_length=FLAGS.min_length, max_length=FLAGS.max_length, pre_audio_transform=FLAGS.transform_audio, hparams=hparams)
