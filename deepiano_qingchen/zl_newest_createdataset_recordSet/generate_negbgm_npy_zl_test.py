...
tf.app.flags.DEFINE_string('input_dir', '/deepiano_data/zhaoliang/qingchen_bgm_data/384_Record_BGM/ipad_pro唱谱原版BGM-11.wav', 'input_dir')
tf.app.flags.DEFINE_string('output_dir', '/deepiano_data/zhaoliang/qingchen_bgm_data/test_dst', 'output_dir')
...
def process_chunk():
    ...
    for start, end in zip(splits[:-1], splits[1:]):
        ...
        for i in range(0, max_spec_y, FLAGS.split_length):
            ...
            onsets_label = onsets = np.zeros((bgm_chunk_spec.shape[0], 88), np.float32)
