...
def to_serialize(npy_files, output_dir):
    ...
    for npy_file in npy_files:
        try:
            ...
            tmp_output_dir = output_dir + '/' + x[5] + '/' + x[6] + '/' +x[7] + '/' +x[8]
            #print(x)
...
input_dir = '/deepiano_data/zhaoliang/record_data/npy_bgm_record_delay'
output_dir0 = '/deepiano_data/zhaoliang/record_data/serialize_bgm_record_delay'
