...
def to_serialize(npy_files, output_dir):
    ...
    for npy_file in npy_files:
        try:
            ...
            x=npy_file.split('/')
            tmp_output_dir = output_dir + '/' + x[6] + '/' + x[7] + '/' +x[8]
...
input_dir = '/deepiano_data/yuxiaofei/work/data_0718/npy_Qingchen_bgm' # './data/npy'#
output_dir0 = '/deepiano_data/yuxiaofei/work/data_0718/serialize_Qingchen_bgm_delay' #'./data/serialize'# 
def main():
    all_wav_dir = []
