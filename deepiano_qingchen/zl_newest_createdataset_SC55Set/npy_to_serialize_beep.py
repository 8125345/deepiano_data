...
def main(input_dir, output_dir0):
    ...
    npy_files.sort()
    print(f'当前npy文件数量：{len(npy_files)}')
...
if __name__ == '__main__':
    input_dir = '/deepiano_data/zhaoliang/SplitModel_data/npy_with_beep_3'
    output_dir0 = '/deepiano_data/zhaoliang/SplitModel_data/serialize_with_beep_3'
