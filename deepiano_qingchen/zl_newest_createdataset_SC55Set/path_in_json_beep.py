...
def write_json(train_file_set, seri_files, json_dir):
    ...
    with open(os.path.join(json_dir, 'beep_train_3.json'), "w+") as json_file:
...
if __name__ == '__main__':
    ...
    serialize_dir = '/deepiano_data/zhaoliang/SplitModel_data/serialize_with_beep_3'
    ...
    print('生成数据集数量：', len(train_file_set))
