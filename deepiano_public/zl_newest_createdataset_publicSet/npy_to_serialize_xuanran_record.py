...
def to_serialize(npy_files, output_dir):
    ...
    for npy_file in npy_files:
        try:
            ...
            tmp_output_dir = output_dir + '/' + x[-6] + '/' + x[-5] + '/' + x[-4] + '/' + x[-3] + '/' + x[-2]
...
if __name__ == '__main__':
    input_dir = '/deepiano_data/zhaoliang/SC55_data/Alignment_data/XuanRan/npy_mix_xuanran'
    output_dir0 = '/deepiano_data/zhaoliang/SC55_data/Alignment_data/XuanRan/serialize_mix_xuanran'
