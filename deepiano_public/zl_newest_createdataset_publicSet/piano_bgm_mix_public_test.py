...
"""
    print('.....................................')
    test_pairs = [('123', '321'), ('456', '654'), ('789', '987')]
    a1 = iter(test_pairs)
    print(a1)
    print('**************************************')
    b1 = (a1,)*5
...
tf.app.flags.DEFINE_string('input_dir', '/deepiano_data/zhaoliang/public_data_test/wav_split', '')
tf.app.flags.DEFINE_string('noise_dir', '/deepiano_data/zhaoliang/qingchen_bgm_data/96_Original_BGM',
                           'Directory where the noise files are.')
tf.app.flags.DEFINE_string('output_dir', '/deepiano_data/zhaoliang/public_data_test/piano_mix_bgm', '')
...
def add_pre_recorded_noise(wav_filename, mid_filename, output_dir, noise_dir):
    ...
    noise_files_info = read_noise_files(noise_dir) #读取bgm文件，返回bgm文件和时长
