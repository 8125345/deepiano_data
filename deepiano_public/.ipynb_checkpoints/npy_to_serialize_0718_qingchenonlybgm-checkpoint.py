...
def to_serialize(npy_files, output_dir):
    ...
    for npy_file in npy_files:
        try:
            ...
            tmp_output_dir = output_dir + '/' + x[5] + '/' + x[6] + '/' +x[7]
            #print(x)
...
input_dir = '/deepiano_data/zhaoliang/qingchen_data/npy_negbgm_record'
output_dir0 = '/deepiano_data/zhaoliang/qingchen_data/serialize_negbgm_record'
